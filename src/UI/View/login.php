...
ob_start();
?>
<div class="container premium-shell d-flex align-items-center justify-content-center min-vh-100">
    <div class="premium-glass login-card text-white">
        <div class="text-center mb-4">
            <div class="login-brand-icon"><i class="bi bi-buildings-fill"></i></div>
            <h1 class="h3 fw-bold mb-1">Repositorio Proyectos PASS</h1>
            <p class="mb-0 login-subtitle">Acceso seguro al hub corporativo de proyectos, documentación y multimedia.</p>
        </div>
